...
if (DEBUG_SETTING === "debug" || DEBUG_SETTING !== "false") {
  ...
  console.warn(
    `LOGGER SET TO DEBUG - ENV: ${NODE_ENV}, DEBUG_SETTING: ${DEBUG_SETTING}`
  );
}
if (DEBUG_SETTING === "info") {
  console.setLevel("info");
  console.warn(
    `LOGGER SET TO INFO - ENV: ${NODE_ENV}, DEBUG_SETTING: ${DEBUG_SETTING}`
  );
}
if (DEBUG_SETTING === "trace") {
  console.setLevel("trace");
  console.warn(
    `LOGGER SET TO TRACE - ENV: ${NODE_ENV}, DEBUG_SETTING: ${DEBUG_SETTING}`
  );
}
